...
- Не используй рекламные штампы: "современный", "эффективный", "надежный", "комфортный", "лучший", "выгодный", "инновационный", если это не прямо указано в характеристиках.
...
PROMPT;
    ...
    private function cleanupStoreVoice(string $text, bool $allowCityPlaceholder): string
    {
        ...
        $text = preg_replace('~\b(?:современн(?:ый|ая|ое|ые|ого|ой|ых)|эффективн(?:ый|ая|ое|ые|ого|ой|ых)|надежн(?:ый|ая|ое|ые|ого|ой|ых)|комфортн(?:ый|ая|ое|ые|ого|ой|ых)|инновационн(?:ый|ая|ое|ые|ого|ой|ых)|выгодн(?:ый|ая|ое|ые|ого|ой|ых))\s+~iu', '', $text) ?? $text;
