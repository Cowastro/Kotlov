    ...
    <section class="section-main-about flat-spacing pt-0">
        <div class="container">
            ...
            <div class="row align-items-center gy-4">
                <div class="col-md-6">
                    <h2>Первый специализированный маркетплейс отопления в Беларуси</h2>
                </div>
                <div class="col-md-6">
                    <p class="text-body-1">
        ...
        <div class="container">
            ...
            <div class="position-relative flat-spacing pb-0">
                ...
                <div dir="ltr" class="swiper tf-swiper"
                    ...
                    <div class="swiper-wrapper">
                        @foreach ([
                            ['icon' => 'icon-Fire',      'title' => 'Котлы',              'desc' => 'Газовые, твердотопливные, электрические, пеллетные'],
                            ['icon' => 'icon-Wind',      'title' => 'Тепловые насосы',     'desc' => 'Воздух-вода, монтаж и подбор под объект'],
                            ['icon' => 'icon-Flame',     'title' => 'Печи и камины',       'desc' => 'Дровяные печи, каминные топки, порталы'],
                            ['icon' => 'icon-Drop',      'title' => 'Водонагреватели',     'desc' => 'Накопительные, проточные, косвенные'],
                            ['icon' => 'icon-Wrench',    'title' => 'Монтаж',              'desc' => 'Сеть партнёров-монтажников по всей Беларуси'],
                            ['icon' => 'icon-Gear',      'title' => 'Автоматика',          'desc' => 'Контроллеры, терморегуляторы, группы безопасности'],
                            ['icon' => 'icon-Factory',   'title' => 'Дымоходы',            'desc' => 'Нержавеющие, керамические, коаксиальные системы'],
                            ['icon' => 'icon-Snowflake', 'title' => 'Климат',              'desc' => 'Вентиляция, кондиционирование, увлажнение'],
                        ] as $dir)
                            <div class="swiper-slide">
                                <div class="box-why">
