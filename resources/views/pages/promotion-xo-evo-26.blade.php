...
<style>
    ...
    @media(max-width:767px){.evo-page .container{width:100%;max-width:100%;padding-right:16px;padding-left:16px}.evo-hero{padding:28px 0 62px}.evo-hero .breadcrumbs{display:none}.evo-hero__grid{display:block;margin-top:18px}.evo-hero h1{font-size:40px;overflow-wrap:break-word}.evo-price__save{flex-basis:100%}.evo-actions{display:grid;margin-bottom:30px}.evo-actions .tf-btn{width:100%;min-width:0}.evo-facts{display:none}.evo-hero__photo,.evo-gallery figure,.evo-system__visual,.evo-system__visual img,.evo-request__photo{min-height:420px;height:420px}.evo-benefits,.evo-gallery,.evo-system,.evo-specs,.evo-video,.evo-request,.evo-faq{padding:72px 0}.evo-request__form{padding:25px 20px}.evo-specs__row{grid-template-columns:1fr;gap:4px}.evo-stock-card{right:12px;bottom:12px;left:12px;align-items:flex-start;flex-direction:column}.evo-gallery__grid{gap:12px}}
</style>
@endpush
...
<main id="wrapper" class="evo-page">
    <section class="evo-hero"><div class="container">
        ...
        <div class="evo-hero__grid"><div>
            ...
            <p class="evo-hero__lead mb-0">Автоматическая пеллетная горелка со сменной топкой AISI 310S, самоочищающимся колосником и контроллером XO-1.0S. Обе акционные горелки физически находятся на складе KOTLOV.</p>
