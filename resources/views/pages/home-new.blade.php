...
@push('styles')
<style>
    .pellet-clearance-slide{position:relative;width:100%;max-width:100%;height:560px;background:#111317;color:#fff;isolation:isolate}.pellet-clearance-slide .sld_image{position:absolute;inset:0}.pellet-clearance-slide .sld_image:after{position:absolute;inset:0;background:linear-gradient(90deg,rgba(7,10,14,.2),rgba(7,10,14,0) 48%,rgba(239,75,75,.05));content:""}.pellet-clearance-slide .sld_image img{width:100%;height:100%;object-fit:cover}.pellet-clearance__layout{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,.96fr) minmax(480px,1.04fr);gap:clamp(28px,3vw,52px);align-items:center;width:100%;height:100%;padding:44px clamp(42px,4vw,70px);box-sizing:border-box}.pellet-clearance__layout>*{min-width:0}.pellet-clearance__copy{min-width:0;max-width:720px}.pellet-clearance__eyebrow{display:inline-flex;align-items:center;gap:9px;margin-bottom:15px;padding:7px 11px;border:1px solid rgba(255,116,109,.28);border-radius:999px;background:rgba(239,75,75,.08);color:#ff7772;font-size:11px;font-weight:700;letter-spacing:.065em}.pellet-clearance__eyebrow:before{width:18px;height:2px;background:currentColor;content:""}.pellet-clearance__copy h2{max-width:680px;margin:0 0 14px;color:#fff;font-size:clamp(44px,3.8vw,64px);line-height:1.01;letter-spacing:-.045em}.pellet-clearance__copy p{max-width:620px;margin:0 0 20px;color:rgba(255,255,255,.7);font-size:17px;line-height:1.48}.pellet-clearance__facts{display:flex;flex-wrap:wrap;gap:8px;margin:0 0 22px}.pellet-clearance__facts span{padding:7px 11px;border:1px solid rgba(255,255,255,.14);border-radius:999px;background:rgba(255,255,255,.025);color:rgba(255,255,255,.75);font-size:12px}.pellet-clearance__products{position:relative;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;align-items:center;min-width:0;height:340px;padding:18px;border:1px solid rgba(255,255,255,.08);border-radius:30px;background:rgba(255,255,255,.035);box-shadow:inset 0 1px 0 rgba(255,255,255,.05)}.pellet-clearance__products:before{position:absolute;z-index:-1;right:8%;bottom:4%;width:72%;height:60%;border-radius:50%;background:rgba(239,75,75,.2);filter:blur(70px);content:""}.pellet-clearance__product{position:relative;display:block;min-width:0;height:250px;padding:39px 9px 45px;overflow:hidden;border:1px solid rgba(255,255,255,.7);border-radius:20px;background:linear-gradient(155deg,#fff 0%,#f2f2f2 100%);box-shadow:0 18px 40px rgba(0,0,0,.25);box-sizing:border-box;transition:transform .25s ease,box-shadow .25s ease}.pellet-clearance__product:nth-child(2){height:292px;transform:translateY(-7px)}.pellet-clearance__product:hover{transform:translateY(-6px);box-shadow:0 24px 48px rgba(0,0,0,.34)}.pellet-clearance__product:nth-child(2):hover{transform:translateY(-12px)}.pellet-clearance__product>img{width:100%;height:100%;object-fit:contain}.pellet-clearance__offer{position:absolute;top:12px;left:12px;z-index:2;padding:6px 9px;border-radius:999px;background:#ef4b4b;color:#fff;font-size:11px;font-weight:700;box-shadow:0 7px 18px rgba(239,75,75,.24)}.pellet-clearance__name{position:absolute;right:10px;bottom:12px;left:10px;color:#17191d;font-size:12px;font-weight:700;line-height:1.22;text-align:center}.pellet-clearance__hotta-visual{display:grid;grid-template-columns:minmax(0,1.3fr) minmax(44px,.7fr);gap:5px;width:100%;height:100%}.pellet-clearance__hotta-render{width:100%;height:100%;object-fit:contain}.pellet-clearance__hotta-real{position:relative;display:grid;grid-template-rows:repeat(2,minmax(0,1fr));gap:4px;min-width:0;overflow:hidden;border-radius:8px}.pellet-clearance__hotta-real:after{position:absolute;right:3px;bottom:3px;padding:2px 4px;border-radius:4px;background:rgba(17,19,23,.78);color:#fff;font-size:7px;font-weight:700;letter-spacing:.04em;content:"ФОТО"}.pellet-clearance__hotta-real img{width:100%;height:100%;min-height:0;object-fit:cover}
    @media(max-width:1439px){.pellet-clearance-slide{height:510px}.pellet-clearance__layout{grid-template-columns:minmax(0,.92fr) minmax(430px,1.08fr);padding:36px 42px}.pellet-clearance__copy h2{font-size:50px}.pellet-clearance__copy p{font-size:15px}.pellet-clearance__products{height:300px;padding:14px}.pellet-clearance__product{height:220px}.pellet-clearance__product:nth-child(2){height:258px}}
    @media(max-width:991px){.pellet-clearance-slide{height:500px}.pellet-clearance__layout{grid-template-columns:minmax(0,1fr) minmax(350px,.92fr);gap:20px;padding:30px}.pellet-clearance__eyebrow{font-size:9px}.pellet-clearance__copy h2{font-size:40px}.pellet-clearance__copy p{font-size:14px}.pellet-clearance__products{height:268px;padding:11px;gap:8px;border-radius:22px}.pellet-clearance__product{height:192px;padding:31px 6px 39px;border-radius:15px}.pellet-clearance__product:nth-child(2){height:222px}.pellet-clearance__offer{top:8px;left:8px;padding:5px 7px;font-size:9px}.pellet-clearance__name{bottom:9px;font-size:10px}}
    @media(max-width:767px){.pellet-clearance-slide{width:100%!important;max-width:100%!important;height:550px}.pellet-clearance__layout{display:flex;flex-direction:column;align-items:stretch;width:100%;max-width:100%;gap:16px;padding:27px 22px 30px;overflow:hidden;box-sizing:border-box}.pellet-clearance__copy,.pellet-clearance__products{width:100%;max-width:100%;min-width:0}.pellet-clearance__copy h2,.pellet-clearance__copy p{width:100%;max-width:100%;white-space:normal;overflow-wrap:anywhere}.pellet-clearance__copy h2{font-size:36px}.pellet-clearance__copy p{margin-bottom:16px;font-size:14px}.pellet-clearance__facts{display:none}.pellet-clearance__copy .tf-btn{min-height:43px}.pellet-clearance__products{flex:1;height:auto;min-height:0;padding:10px;gap:8px;border-radius:20px}.pellet-clearance__product,.pellet-clearance__product:nth-child(2){width:100%;height:100%;min-height:145px;padding:31px 5px 36px;border-radius:14px;transform:none}.pellet-clearance__product:hover,.pellet-clearance__product:nth-child(2):hover{transform:none}.pellet-clearance__offer{top:7px;left:7px;padding:5px 6px;font-size:9px}.pellet-clearance__name{right:6px;bottom:8px;left:6px;font-size:9px;overflow-wrap:anywhere}}
    @media(max-width:575px){.pellet-clearance-slide{height:485px}.pellet-clearance__layout{gap:11px;padding:19px 14px 23px}.pellet-clearance__eyebrow{margin-bottom:8px;padding:5px 8px;font-size:8px}.pellet-clearance__copy h2{margin-bottom:8px;font-size:28px;line-height:1}.pellet-clearance__copy p{margin-bottom:11px;font-size:12px;line-height:1.35}.pellet-clearance__copy .tf-btn{min-height:38px;padding:8px 14px;font-size:11px}.pellet-clearance__products{padding:7px;gap:6px;border-radius:16px}.pellet-clearance__product,.pellet-clearance__product:nth-child(2){min-height:122px;padding:27px 3px 34px}.pellet-clearance__offer{top:6px;left:5px;font-size:8px}.pellet-clearance__name{font-size:8px}}
</style>
@endpush
                                ...
                                <div class="slider-wrap slideshow-wrap rounded-20 overflow-hidden pellet-clearance-slide" id="pellet-clearance">
                                    ...
                                    <div class="pellet-clearance__layout">
                                        ...
                                        <div class="pellet-clearance__products" aria-label="Акционные пеллетные горелки">
                                            ...
                                            <a href="/akcii/kotlov-xo-evo-26" class="pellet-clearance__product"><span class="pellet-clearance__offer">−20%</span><img loading="eager" src="{{ asset('img/promotions/kotlov-xo-evo-26-stock-cover.jpg') }}" alt="KOTLOV XO EVO 26 кВт"><span class="pellet-clearance__name">XO EVO<br>26 кВт</span></a>
                                            <a href="/akcii/hotta-ceramik-20-30" class="pellet-clearance__product"><span class="pellet-clearance__offer">от 4 300 BYN</span><span class="pellet-clearance__hotta-visual"><img class="pellet-clearance__hotta-render" loading="eager" src="{{ asset('img/promotions/hotta-ceramik/hotta-20-1.jpg') }}" alt="Рендер HOTTA Ceramik 20 и 30 кВт"><span class="pellet-clearance__hotta-real"><img loading="eager" src="{{ asset('img/promotions/hotta-ceramik/hotta-stock-real-side.jpg') }}" alt="Реальная фотография HOTTA Ceramik"><img loading="eager" src="{{ asset('img/promotions/hotta-ceramik/hotta-stock-real-firebox.jpg') }}" alt="Реальная топка HOTTA Ceramik"></span></span><span class="pellet-clearance__name">HOTTA Ceramik<br>20 / 30 кВт</span></a>
                                        </div>
                                    </div>
                                </div>
                                @else
