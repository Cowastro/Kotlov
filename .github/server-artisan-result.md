...
- Log file: `storage/logs/audit-varmega-empty-cards-after-inox-tail.log`
- Exit code: `0`

```text
From https://github.com/Cowastro/Kotlov
   1b72b84..f180afb  main       -> origin/main
Updating 1b72b84..f180afb
Fast-forward
 .github/server-artisan-result.md | 84 ++++++++++++++++++++++++++--------------
 .github/server-artisan-task.json |  8 ++--
 2 files changed, 58 insertions(+), 34 deletions(-)
Products with content-health issues: 89
Showing rows: 89 (limit 220)
...
| 20717 | KOTLOV-005883 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM04302 3/4"                                       |
| 20720 | KOTLOV-005886 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16606 1/2", 4 бар                                |
| 20721 | KOTLOV-005887 | Varmega | Котлы отопления                           | rn-profi  | 4     | low_attrs          | rn-profi.by    | Varmega VM16624 1/2" х 3/4", 3 бар                         |
| 20722 | KOTLOV-005888 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16627 1/2" х 3/4", 6 бар                         |
| 20723 | KOTLOV-005889 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16628 1/2" х 3/4", 8 бар                         |
| 20724 | KOTLOV-005890 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16629 1/2" х 3/4", 10 бар                        |
| 20725 | KOTLOV-005891 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16644 3/4" х 1", 3 бар                           |
| 20726 | KOTLOV-005892 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16647 3/4" х 1", 6 бар                           |
| 20727 | KOTLOV-005893 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16648 3/4" х 1", 8 бар                           |
| 20728 | KOTLOV-005894 | Varmega | Котлы отопления                           | rn-profi  | 0     | no_photo,low_attrs | rn-profi.by    | Varmega VM16649 3/4" х 1", 10 бар                          |
