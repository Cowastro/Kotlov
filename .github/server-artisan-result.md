...
From https://github.com/Cowastro/Kotlov
   ee1fc257..95e55fc5  main       -> origin/main
Updating ee1fc257..95e55fc5
Fast-forward
 .github/server-artisan-result.md                   | 85 +++++++++++++++-------
 .github/server-artisan-task.json                   |  2 +-
 .../SyncTeplovSukhovRetailPricesCommand.php        | 58 ++++++++++++++-
...
+--------------------------------------+------------+
| Строк в прайсе                       | 144        |
| Безопасно сопоставлено               | 43         |
| Цен обновлено                        | 0          |
| Без изменения                        | 43         |
| Неоднозначных — пропущено            | 3          |
| Не найдено — пропущено               | 92         |
| Конфликтов связи — пропущено         | 0          |
| Конфликтов внутри прайса — пропущено | 2          |
+--------------------------------------+------------+
+-----------------------+--------------------------------------------+-----------------------------------------------------------------------+
