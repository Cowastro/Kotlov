...
- Time: 2026-07-11 17:26:39 UTC
- Task: `artisan-dry-run`
- Artisan args: `products:audit-content-health --active-only --not-archived --with-source-only --issues=no_content,no_short,thin_content --limit=160`
- Log file: ``
- Exit code: `0`

```text
From https://github.com/Cowastro/Kotlov
   6d7c238..69a8db6  main       -> origin/main
Updating 6d7c238..69a8db6
Fast-forward
 .github/server-artisan-result.md | 176 +++++++++++++++++++++++++++++++++++++--
 .github/server-artisan-task.json |   8 +-
 2 files changed, 172 insertions(+), 12 deletions(-)
Products with content-health issues: 239
...
| 17034 | KOTLOV-004756 | Kratki     | Каминные топки                     | ligmet      | 0     | no_short,low_attrs                     | ligmet.by        | Kratki Каминная топка FLOKI/L/L/BLACK                      |
| 17035 | KOTLOV-004757 | Kratki     | Каминные топки                     | ligmet      | 0     | no_short,low_attrs                     | ligmet.by        | Kratki Каминная топка FLOKI/L/P                            |
| 17036 | KOTLOV-004758 | Kratki     | Каминные топки                     | ligmet      | 0     | no_short,low_attrs                     | ligmet.by        | Kratki Каминная топка FLOKI/L/P/BLACK                      |
...
| 17040 | KOTLOV-004762 | Nordflam   | Каминные топки                     | ligmet      | 0     | no_photo,no_short,low_attrs            | ligmet.by        | Nordflam Топка каминная Etna EKO правая                    |
...
| 17041 | KOTLOV-004763 | Panadero   | Каминные топки                     | ligmet      | 0     | no_photo,no_short,low_attrs            | ligmet.by        | Panadero Камин 101-S Ecodesign                             |
