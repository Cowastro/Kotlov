...
- Time: 2026-07-12 08:03:22 UTC
- Task: `artisan-dry-run`
- Artisan args: `products:audit-content-health --active-only --not-archived --with-source-only --max-attrs=2 --limit=200 --csv=storage/app/reports/content-health/content-health-with-source.csv`
- Log file: ``
- Exit code: `0`

```text
From https://github.com/Cowastro/Kotlov
   ade6b56..9a8a036  main       -> origin/main
Updating ade6b56..9a8a036
Fast-forward
 .github/server-artisan-result.md | 313 ++++++++++++++++++++++++++++++++++++---
 .github/server-artisan-task.json |   4 +-
 2 files changed, 295 insertions(+), 22 deletions(-)
Products with content-health issues: 821
...
| 15973 | KOTLOV-003695 | Hommyn      | Автоматика и терморегуляторы       | rusklimat    | 1     | low_attrs                              | rusklimat.by     | Модуль съемный управляющий HOMMYN HDN/WFN-02-02            |
| 15974 | KOTLOV-003696 | Hommyn      | Автоматика и терморегуляторы       | rusklimat    | 1     | low_attrs                              | rusklimat.by     | Модуль съемный управляющий HOMMYN HDN/WFN-02-08            |
| 15977 | KOTLOV-003699 | Hommyn      | Автоматика и терморегуляторы       | rusklimat    | 0     | low_attrs                              | rusklimat.by     | Кронштейн поворотный для монтажа датчика движения HOMMY... |
| 15982 | KOTLOV-003704 | Hommyn      | Автоматика и терморегуляторы       | rusklimat    | 1     | low_attrs                              | rusklimat.by     | Манипулятор шарового крана HOMMYN электрический WZB400W    |
| 15984 | KOTLOV-003706 | Hommyn      | Автоматика и терморегуляторы       | rusklimat    | 0     | low_attrs                              | rusklimat.by     | Диммер выключатель круглый HOMMYN zigbee DSRZBN01W         |
| 15985 | KOTLOV-003707 | Hommyn      | Автоматика и терморегуляторы       | rusklimat    | 0     | low_attrs                              | rusklimat.by     | Розетка умная встраиваемая HOMMYN zigbee RKNWOZB01W        |
| 15988 | KOTLOV-003710 | Hommyn      | Автоматика и терморегуляторы       | rusklimat    | 2     | low_attrs                              | rusklimat.by     | Модуль реле HOMMYN с сухим контактом 1 канал DCRLZBN01     |
...
+-------+---------------+-------------+------------------------------------+--------------+-------+----------------------------------------+------------------+------------------------------------------------------------+
CSV written: /var/www/h209767/data/www/new.kotlov.by/storage/app/reports/content-health/content-health-with-source.csv
